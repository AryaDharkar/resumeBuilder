...
export default function UserData() {
  ...
  return (
    <Box sx={{ display: "flex" }}>
      ...
      >
        <Toolbar sx={{ "background-color": "#fff" }}>
          <IconButton
            color="primary"
          ...
          <Typography variant="h6" noWrap component="div">
            <a href="/" className="text-xl text-gray-700 font-bold">
              Free Resume Builder
            </a>
          </Typography>
        </Toolbar>
      ...
      >
        {selectedIndex === 0 ? (
          <Step1 setSelectedIndex={setSelectedIndex} />
        ) : selectedIndex === 1 ? (
          <Step2 setSelectedIndex={setSelectedIndex} />
        ) : selectedIndex === 2 ? (
          <Step3 setSelectedIndex={setSelectedIndex} />
        ) : selectedIndex === 3 ? (
          <Step4 setSelectedIndex={setSelectedIndex} />
        ) : selectedIndex === 4 ? (
          <Step5 setSelectedIndex={setSelectedIndex} />
        ) : selectedIndex === 5 ? (
          <Step6 />
        ) : null}
      </Box>
