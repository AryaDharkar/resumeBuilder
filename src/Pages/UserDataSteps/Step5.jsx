...
const ResumeForm = () => {
    ...
    useEffect(() => {
        ...
        if (userData.step5 && userData.step5.summary) {
    ...
    const handleGenerate = async () => {
        try {
            ...
            const response = await fetch('http://localhost:11434/api/generate', {
                ...
                body: JSON.stringify({
                    model: "resubuilder",
                    prompt: "Write a summary for the data: " + JSON.stringify(userData.step1) + JSON.stringify(userData.step2) + JSON.stringify(userData.step3) + JSON.stringify(userData.step4),
                }),
            });
    ...
    return (
        <Container>
            ...
            <Button variant="contained" color="secondary" onClick={handleGenerate} style={{ marginTop: '10px', marginLeft: '10px' }}>
                Generate
            </Button>
        </Container>
    );
